...
import type { CustomerInquiry as _CustomerInquiry, InquiryId as _InquiryId, ProductId as _ProductId, Time as _Time, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async submitInquiry(arg0: string, arg1: string, arg2: string, arg3: string | null, arg4: ProductId, arg5: bigint, arg6: string): Promise<InquiryId> {
        if (this.processError) {
            try {
                const result = await this.actor.submitInquiry(arg0, arg1, arg2, to_candid_opt_n9(this._uploadFile, this._downloadFile, arg3), arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        companyName: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.companyName)),
        phone: value.phone,
