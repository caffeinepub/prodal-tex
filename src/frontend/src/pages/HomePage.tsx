    ...
    <div className="flex flex-col">
      ...
      <section className="relative min-h-[520px] md:min-h-[600px] flex items-center overflow-hidden bg-charcoal-dark">
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-2xl">
            ...
            <p className="font-body text-base md:text-lg text-white leading-relaxed mb-8 max-w-xl">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div>
              ...
              <h2 className="font-heading text-3xl md:text-4xl font-semibold text-white mt-2">
                Clothing
              </h2>
              <p className="font-body text-base text-white/90 mt-2">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
            <div>
              ...
              <p className="font-body text-base text-foreground/70 mt-2">
      ...
      <section className="py-16 md:py-20 bg-charcoal-dark">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="font-body text-base text-white/90 mb-8 max-w-xl mx-auto">
